...
// -----------------------------
// Petit utilitaire Node.js pour scanner le dossier `produit/` et générer
// automatiquement `src/data/products.json`.
...
function relUrl(file) {
  // convertit un chemin absolu en URL relative utilisée par Vite (en commençant par /)
